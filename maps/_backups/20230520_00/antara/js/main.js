...
var promises = [
	fetchData('config', '../json/config.json'),
	fetchData('villages', '../json/villages.json'),
	fetchData('guardtowers', '../json/guardtowers.json'),
	fetchData('structures', '../json/structures.json'),
	fetchData('portals', '../json/portals.json')
];
